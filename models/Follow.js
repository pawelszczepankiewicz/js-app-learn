...
Follow.prototype.validate = async function (action) {
    ...
    if (action == "delete") {
        if (!doesFollowAlreadyExist) { this.errors.push("You are not following this account") }
    }
    //Should not be albe to follow yourself
    if (this.followedId == this.authorId) { this.errors.push("You can not follow yourself") }
}
